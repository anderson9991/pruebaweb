...
<head>
	...
	<title>@hasSection('title') @yield('title') | @endif {{ config('app.name', 'Home') }}</title>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        @guest
                            ...
                            @endif
                            @if (Route::has('comentarios'))
                                <li class="nav-item">
                                    <a class="nav-link" href="{{ route('comentarios') }}">{{ __('Comentarios de texto') }}</a>
                                </li>
                            @endif
